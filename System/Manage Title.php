...
<html>
  ...
  <div class="container-fluid">
	...
	<form action="Add Title.php" method="get">
				<input type="submit" value="Add Title" name="Submit" id="frm1_submit" />				
	</form>
	
	<form action="Delete Title.php" method="get">
				<input type="submit" value="Delete Title" name="Submit" id="frm1_submit" />				
	</form>
	
	<form action="Inquire Title.php" method="get">
